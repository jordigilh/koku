...
class PodAggregator:
    ...
    def _join_cost_category(
        ...
        Returns:
            Joined DataFrame
        """
        # Implement LIKE matching
        # For POC, we'll do a simple startswith match
        # TODO: Implement SQL LIKE pattern matching
...
def calculate_node_capacity(pod_usage_df: pd.DataFrame) -> Tuple[pd.DataFrame, pd.DataFrame]:
    ...
    with PerformanceTimer("Calculate node/cluster capacity", logger):
        ...
        # Step 3: Calculate cluster capacity (sum across all nodes per day)
        ...
        # Join cluster capacity back to node capacity
