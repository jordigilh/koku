...
class TestCostAttributor:
    ...
    def test_join_ocp_with_aws_by_resource_id(self, mock_config, sample_ocp_pod_usage, sample_aws_matched):
        ...
        result = attributor.join_ocp_with_aws(sample_ocp_pod_usage, sample_aws_matched)
    ...
    def test_join_ocp_with_aws_empty_ocp(self, mock_config, sample_aws_matched):
        ...
        result = attributor.join_ocp_with_aws(pd.DataFrame(), sample_aws_matched)
    ...
    def test_join_ocp_with_aws_empty_aws(self, mock_config, sample_ocp_pod_usage):
        ...
        result = attributor.join_ocp_with_aws(sample_ocp_pod_usage, pd.DataFrame())
    ...
    def test_attribute_compute_costs_empty_inputs(self, mock_config):
        ...
        result = attributor.attribute_compute_costs(pd.DataFrame(), pd.DataFrame())
...
class TestStorageCostAttribution:
    ...
    def test_non_csi_tag_based_storage_attribution(self, mock_config):
        ...
        assert (
            "legacy-app" in result["namespace"].values
        ...
        ocp_storage_df = pd.DataFrame(
            {
                ...
                "persistentvolumeclaim_capacity_gigabyte": [
                    40,
                    30,
                ],  # 40 + 30 = 70 GB claimed of 100 GB disk
