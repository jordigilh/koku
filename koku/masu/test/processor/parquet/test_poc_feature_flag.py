...
class TestPOCFeatureFlag(TestCase):
    ...
    def test_feature_flag_defaults_to_false(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            flag_value = os.environ.get("USE_POC_AGGREGATOR", "False").lower() == "true"
    ...
    def test_feature_flag_enabled_by_env_var(self):
        ...
        with patch.dict(os.environ, {"USE_POC_AGGREGATOR": "True"}):
            flag_value = os.environ.get("USE_POC_AGGREGATOR", "False").lower() == "true"
    ...
    def test_feature_flag_case_insensitive(self):
        ...
        for value in ["true", "True", "TRUE", "1"]:
            with patch.dict(os.environ, {"USE_POC_AGGREGATOR": value}):
                flag_value = os.environ.get("USE_POC_AGGREGATOR", "False").lower() in ("true", "1")
