...
class PodAggregator:
    ...
    def __init__(
        ...
        """Initialize pod aggregator with koku-native parameters.
        ...
        use_arrow_env = os.getenv("POC_USE_ARROW_COMPUTE", "false").lower() == "true"
        self.use_arrow = use_arrow_env and ARROW_AVAILABLE
        if self.use_arrow:
            ...
            if use_arrow_env and not ARROW_AVAILABLE:
    ...
    def aggregate_streaming(
        ...
        parallel_enabled = os.getenv("POC_PARALLEL_CHUNKS", "false").lower() == "true"
        max_workers = int(os.getenv("POC_MAX_WORKERS", "4"))
